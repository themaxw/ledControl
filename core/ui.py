...
class UIUrl(UIElement):

    def __init__(self, displayName: str, parameterName: str, url: str):
        super().__init__(displayName, parameterName, "url")
        self.url = url
        self._changedUrl = False
    ...
    def valueDict(self):
        return {self.parameterName: {"url": self.url}}
